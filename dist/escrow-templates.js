...
exports.ESCROW_TEMPLATES = void 0;
exports.getTemplate = getTemplate;
exports.listTemplates = listTemplates;
exports.listTemplatesByVertical = listTemplatesByVertical;
exports.getVerticals = getVerticals;
/**
 * Pre-built escrow templates
 */
exports.ESCROW_TEMPLATES = {
    // ============ REAL ESTATE ============
    earnest_money: {
...
function getTemplate(name) {
    return exports.ESCROW_TEMPLATES[name];
}
/**
 * List all templates
 */
function listTemplates() {
    return Object.values(exports.ESCROW_TEMPLATES);
}
/**
 * List templates by vertical
 */
function listTemplatesByVertical(vertical) {
    return Object.values(exports.ESCROW_TEMPLATES).filter(t => t.vertical === vertical);
}
/**
 * Get all verticals
 */
...
//# sourceMappingURL=escrow-templates.js.map