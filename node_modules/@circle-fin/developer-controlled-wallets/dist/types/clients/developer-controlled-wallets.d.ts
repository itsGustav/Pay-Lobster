...
declare const WalletsApiAxiosParamCreator: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    listWalletBallance: (id: string, includeAll?: boolean, name?: string, tokenAddress?: string, standard?: string, pageBefore?: string, pageAfter?: string, pageSize?: number, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    listWalletNfts: (id: string, includeAll?: boolean, name?: string, tokenAddress?: string, standard?: string, pageBefore?: string, pageAfter?: string, pageSize?: number, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
...
declare const WalletsApiFp: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    listWalletBallance(id: string, includeAll?: boolean, name?: string, tokenAddress?: string, standard?: string, pageBefore?: string, pageAfter?: string, pageSize?: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ListWalletBallance200Response>>;
    /**
     * Fetches the info for all NFTs stored in a single developer-controlled wallet, using the wallets unique identifier.
     * @summary Get NFTs for a wallet
     * @param {string} id Wallet ID
     ...
     * @throws {RequiredError}
     */
    listWalletNfts(id: string, includeAll?: boolean, name?: string, tokenAddress?: string, standard?: string, pageBefore?: string, pageAfter?: string, pageSize?: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ListWalletNfts200Response>>;
    /**
     * Retrieves a list of all developer-controlled wallets that fit the specified parameters.
     * @summary List wallets
     * @param {string} [address] Filter by the Address of the wallet.
...
declare const WalletsApiFactory: (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) => {
     ...
     * @throws {RequiredError}
     */
    listWalletBallance(id: string, includeAll?: boolean, name?: string, tokenAddress?: string, standard?: string, pageBefore?: string, pageAfter?: string, pageSize?: number, options?: any): AxiosPromise<ListWalletBallance200Response>;
    /**
     * Fetches the info for all NFTs stored in a single developer-controlled wallet, using the wallets unique identifier.
     * @summary Get NFTs for a wallet
     * @param {string} id Wallet ID
     ...
     * @throws {RequiredError}
     */
    listWalletNfts(id: string, includeAll?: boolean, name?: string, tokenAddress?: string, standard?: string, pageBefore?: string, pageAfter?: string, pageSize?: number, options?: any): AxiosPromise<ListWalletNfts200Response>;
    /**
     * Retrieves a list of all developer-controlled wallets that fit the specified parameters.
     * @summary List wallets
     * @param {string} [address] Filter by the Address of the wallet.
...
declare class WalletsApi extends BaseAPI {
     ...
     * @memberof WalletsApi
     */
    listWalletBallance(id: string, includeAll?: boolean, name?: string, tokenAddress?: string, standard?: string, pageBefore?: string, pageAfter?: string, pageSize?: number, options?: AxiosRequestConfig): Promise<axios.AxiosResponse<ListWalletBallance200Response, any>>;
    /**
     * Fetches the info for all NFTs stored in a single developer-controlled wallet, using the wallets unique identifier.
     * @summary Get NFTs for a wallet
     * @param {string} id Wallet ID
     ...
     * @memberof WalletsApi
     */
    listWalletNfts(id: string, includeAll?: boolean, name?: string, tokenAddress?: string, standard?: string, pageBefore?: string, pageAfter?: string, pageSize?: number, options?: AxiosRequestConfig): Promise<axios.AxiosResponse<ListWalletNfts200Response, any>>;
    /**
     * Retrieves a list of all developer-controlled wallets that fit the specified parameters.
     * @summary List wallets
     * @param {string} [address] Filter by the Address of the wallet.
